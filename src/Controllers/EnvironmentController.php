...
use Laravel\PhpLaravel\Events\EnvironmentSaved;
...
class EnvironmentController extends Controller
{
    ...
    {
        return view('php-laravel.phplaravel.environment');
    }
    ...
    public function environmentWizard()
    {
        ...
        return view('php-laravel.phplaravel.environment-wizard', compact('envConfig'));
    }
    ...
    public function environmentClassic()
    {
        ...
        return view('php-laravel.phplaravel.environment-classic', compact('envConfig'));
    }
    ...
    public function saveClassic(Request $input, Redirector $redirect)
    {
        ...
        return $redirect->route('PhpLaravel::environmentClassic')
    ...
    {
        $rules = config('phplaravel.environment.form.rules');
        $messages = [
        ...
        if ($validator->fails()) {
            return $redirect->route('PhpLaravel::environmentWizard')->withInput()->withErrors($validator->errors());
        }

        if (! $this->checkDatabaseConnection($request)) {
            return $redirect->route('PhpLaravel::environmentWizard')->withInput()->withErrors([
...
//         }
        ...
        return $redirect->route('PhpLaravel::database', ['email' => $request->admin_email, 'password' => $request->admin_password])
